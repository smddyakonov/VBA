...
' long-таблица
' модификации по СТОЛБЦАМ, параметры по СТРОКАМ
Sub WideToLong_FromInputRanges()
    ...
    ' после выбора rngMods знаем, в КАКОЙ книге и на КАКОМ листе работаем
    Set srcWs = rngMods.Worksheet
    Set wb = srcWs.Parent      ' это и будет, например, 'Mvlticae-15.xlsx'
